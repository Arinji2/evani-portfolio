...
export function Navbar() {
	...
	return (
		<div
			className={cn(
				"fixed top-0 z-40 flex h-[80px] w-full flex-row items-center justify-center border-b-2 border-b-blue/20 bg-background px-6 transition-transform duration-300 ease-in-out",
				{
					"-translate-y-full": pathname === "/" && scrolled < 40,
				},
			)}
		>
			<div className="h-full w-full max-w-pageMax px-6">
